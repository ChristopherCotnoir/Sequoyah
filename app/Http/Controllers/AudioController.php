...
class AudioController extends Controller
{
    ...
    */
    ...
    public function RemoveRowAudioSample($syllabaryId, $rowId)
    {
        $row = SyllabaryRowHeader::where('syllabary_id', '=', $syllabaryId)->
        where('id', '=', $rowId)->first();

        try { Storage::delete($row->audio_sample); } catch (\Exception $e) { }
    ...
    public function RemoveColumnAudioSample($syllabaryId, $columnId)
    {
        ...
        try { Storage::delete($column->audio_sample); } catch (\Exception $e) { }
